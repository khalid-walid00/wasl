...
function CommercialRecordIssueDateHijri() {
    const {
        company: { CommercialRecordIssueDateHijri }
    ...
    return (
        <div className="flex flex-col z-[888] gap-2">
...
export default CommercialRecordIssueDateHijri;
