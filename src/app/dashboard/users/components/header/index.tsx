  ...
  return (
    <div className="flex flex-col gap-6 p-4 pb-0">
      <div className=" flex gap-3 flex-col sm:flex-row">
        ...
        <CustomInput placeholder='Search by Name' className='bg-[--linerPrimary]'/>
      <CustomInput placeholder='Search by Phone' className='bg-[--linerPrimary]'/>
      <CustomInput placeholder='Search by Email' className='bg-[--linerPrimary]'/>
